...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        shift_upper_values = upper_values[shift:] + lower_values[:shift]
        
        full_keys = lower_keys + upper_keys
        full_values = shift_lower_values + shift_upper_values
        
        
        self.dictionary = dict(zip(full_keys, full_values))
    ...
    def apply_shift(self, shift):
        ...
        '''
        #create new string that is self.message_text shifted down the alphabet
        #create empty list (so it can be mutable )
        new_msg = []
